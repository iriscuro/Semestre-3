        ...
        switch(caracter){
            case KEY_DOWN://abajo
                if(y<=2){
                    ...
                    *(*(romp+y)+x) = *(*(romp +y+1)+x);//romp[y+1][x]
                    *(*(romp+y+1)+x)=0; //romp[y+1][x]=0;
                    system("cls");
                    imprimir();
                    y++;
                }
            ...
            case KEY_UP: //arriba
                if(y>=1){
                    //moviendo ficha
                    *(*(romp+y)+x)=*(*(romp+y-1)+x);//romp[y][x]= romp[y-1][x];
                    *(*(romp+y-1)+x)=0;//romp[y-1][x] = 0;
                    system("cls");
                    imprimir();
                    y--;
            ...
            case KEY_RIGHT: //derecha
                if(x<=2){
                    *(*(romp+y)+x)=*(*(romp+y)+x+1);//romp[y][x]= romp[y][x+1];
                    *(*(romp+y)+x+1)=0;//romp[y][x+1]=0;
                    system("cls");
                    imprimir();
                    x++;
                }
